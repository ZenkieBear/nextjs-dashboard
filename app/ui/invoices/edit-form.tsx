...
export default function EditInvoiceForm({
  ...
  // The Server Action will be populate with id(from here) and FormData(from the NextJS)
  // Seems like: const proxyAction = (formData: FormData) => updateInvoice(invoice.id, formData)
